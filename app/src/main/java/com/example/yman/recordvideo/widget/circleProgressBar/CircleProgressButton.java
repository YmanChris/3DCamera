 ...
 */
package com.example.yman.recordvideo.widget.circleProgressBar;
...
import com.example.yman.recordvideo.util.CommonUtils;
...
public class CircleProgressButton extends View {
    ...
    private static final long TIME_INTERVAL = 28;
     ...
     * 圆弧渐变的角度增加
     */
    private int everyIntervalAngle = 1;
    ...
    private int longestTime = 10 * 1000;//设置最长录制时间10s
...
//                    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Toast.makeText(YYApplication.getInstance(),"return false",Toast.LENGTH_SHORT).show();
        return false;
